...
UPDATE users SET bio = "Looking for my dream dog", energy = "Low", age = 60, backyard = "Small", current_dog = "No", free_time = "High", Strength = "Medium" WHERE id = "1";

SELECT * FROM pets WHERE aggression="Low" AND energy="Medium" AND maintenance="Medium";

DELETE FROM favourites WHERE id = "aehdkbc82n-ddi29d-wddn";
